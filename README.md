...
## 🐙 How to Submit as a GitHub Repository — Step by Step
...
3. Fill in the details:
   - Repository name: googlepay-expense-sharing
   - Description: Simple Python expense sharing program using numpy and prettytable
   - Visibility: Public
...
3. Drag and drop these 3 files:
   ...
   - requirements.txt
   - README.md
4. Write a commit message: Add expense sharing project files
...
4. Paste the full content from your downloaded README.md
5. Click "Commit changes"

---

### ✅ Step 5 — Add a Screenshot
1. Run the program in Google Colab or terminal
2. Take a screenshot of the output
3. Go back to your repo, click "Add file" -> "Upload files"
4. Upload your screenshot (name it screenshot.png)
5. Click "Commit changes"

---

### ✅ Step 6 — Copy and Submit Your GitHub Link
Your repository link will look like this:
```
https://github.com/your-username/googlepay-expense-sharing
```
Copy this link and submit it as your project submission.
